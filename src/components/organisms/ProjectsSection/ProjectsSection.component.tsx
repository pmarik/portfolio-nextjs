...
const ProjectsSection:React.FC = () => {
    return (
        <>
            <p className="pt-20 bg-white w-full text-center text-slate-950">featured projects</p>
            <div className="relative bg-white w-full px-6 md:px-20 text-center md:text-left">
                <div className="text-gray-950 grid grid-cols-1 md:grid-cols-6 my-40 md:grid-rows-[repeat(3,auto)]">
                    <h2 className="title-clamp row-start-1 mb-4">placeholder</h2>
                    <p className="col-start-1 col-end-4 row-start-2 md:row-start-2 md:pr-8 lg:pr-24 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
